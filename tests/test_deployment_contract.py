...
class DeploymentContractTest(unittest.TestCase):
    ...
    def test_compose_uses_one_public_reality_port_and_internal_slot_routing(self):
        ...
        self.assertIn("kui-cloudshell-origin:", compose)
        self.assertIn("kui-cloudflared:", compose)
        self.assertIn("kui-cloudshell-secrets:/run/secrets:ro", compose)
        self.assertIn("kui-cloudshell-origin:/run/origin", compose)
        self.assertIn("cloudflare/cloudflared:latest", compose)
